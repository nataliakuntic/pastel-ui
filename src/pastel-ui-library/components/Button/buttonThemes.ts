    ...
    dustyrose: {
      ...
      variants: {
        primary: {
          ...
          outlineFoc: "focus:outline-button-dustyrose-focus-outline",
        },
        secondary: {
        ...
        danger: {
          ...
          bgHover: "hover:bg-button-dustyrose-hover",
          bgActive: "active:bg-button-dustyrose-active",
          border: "border-button-dustyrose-delete-stroke",
          borderDisabled: "border-button-dustyrose-disabled-stroke",
          outlineFoc: "focus:outline-button-dustyrose-focus-outline",
        },
      },
    ...
    pistacchio: {
      ...
      variants: {
        primary: {
          ...
          outlineFoc: "focus:outline-button-pistacchio-focus-outline",
        },
        secondary: {
        ...
        danger: {
          ...
          bgHover: "hover:bg-button-pistacchio-hover",
          bgActive: "active:bg-button-pistacchio-active",
          border: "border-button-pistacchio-delete-stroke",
          borderDisabled: "border-button-pistacchio-disabled-stroke",
          outlineFoc: "focus:outline-button-pistacchio-focus-outline",
        },
      },
    ...
    honey: {
      ...
      variants: {
        primary: {
          ...
          outlineFoc: "focus:outline-button-honey-focus-outline",
        },
        secondary: {
        ...
        danger: {
          ...
          bgHover: "hover:bg-button-honey-hover",
          bgActive: "active:bg-button-honey-active",
          border: "border-button-honey-delete-stroke",
          borderDisabled: "border-button-honey-disabled-stroke",
          outlineFoc: "focus:outline-button-honey-focus-outline",
        },
      },
    ...
    aquafrost: {
      ...
      variants: {
        primary: {
          ...
          outlineFoc: "focus:outline-button-aquafrost-focus-outline",
        },
        secondary: {
        ...
        danger: {
          ...
          bgHover: "hover:bg-button-aquafrost-hover",
          bgActive: "active:bg-button-aquafrost-active",
          border: "border-button-aquafrost-delete-stroke",
          borderDisabled: "border-button-aquafrost-disabled-stroke",
          outlineFoc: "focus:outline-button-aquafrost-focus-outline",
        },
      },
    ...
    lilac: {
      ...
      variants: {
        primary: {
          ...
          outlineFoc: "focus:outline-button-lilac-focus-outline",
        },
        secondary: {
        ...
        danger: {
          ...
          bgHover: "hover:bg-button-lilac-hover",
          bgActive: "active:bg-button-lilac-active",
          border: "border-button-lilac-delete-stroke",
          borderDisabled: "border-button-lilac-disabled-stroke",
          outlineFoc: "focus:outline-button-lilac-focus-outline",
        },
      },

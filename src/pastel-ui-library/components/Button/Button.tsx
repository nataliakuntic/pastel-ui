...
const Button: React.FC<ButtonProps> = ({
  ...
  const buttonClass = classNames(
    "font-inter font-semibold border px-6 py-2 transition gap-5 focus-outline:none focus-visible:outline-none focus:ring-solid focus:ring-2 focus:ring-offset-2",
